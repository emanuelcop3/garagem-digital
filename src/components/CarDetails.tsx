...
export default function CarDetails({ car, onClose }: CarDetailsProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden relative animate-slideUp card-shadow">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 bg-white/10 backdrop-blur-sm text-white p-2 rounded-full hover:bg-white/20 transition-colors z-20"
        >
        ...
        <div className="relative h-72 w-full bg-gradient-to-br from-gray-50 to-gray-100">
          {imageError ? (
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
              <svg
                className="w-20 h-20 text-gray-400 transform -rotate-12"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center space-x-3">
                <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-indigo-50 to-pink-50 text-indigo-600">
                  {car.Location}
                </span>
              </div>
            </div>
